...
$$P(S|F)=\frac{8}{35}=0.22857$$
$$P(S|M)=\frac{20}{57}=0.35087$$


I believe the table suggests that there is a higher probablity that if you are male you're more likely to be a smoker, concluding that there is a relationship between gender and smoking.
